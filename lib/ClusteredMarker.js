   ...
   return (
      ...
      >
         ...
         <View style={{ width: width * 1.5, height: height * 1.5, justifyContent: "center", alignItems: "center" }}>
            <View>
               <Image source={{ uri: picturePaths ? picturePaths.xs : null }} style={{ zIndex: 10, width, height, borderWidth, backgroundColor: clusterColor, borderColor: clusterTextColor, borderRadius }} />
               {points >= 2
                  ? <View style={{
